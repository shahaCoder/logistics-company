    ...
    >
      ...
      {showSidebar && (
        <aside className="hidden md:block w-56 flex-shrink-0 bg-slate-900 dark:bg-slate-950 border-r border-slate-800 dark:border-slate-800 min-h-screen sticky top-0 overflow-y-auto">
          <div className="p-4">
            {/* Logo/Brand */}
            <div className="mb-4 pt-3 pb-2 px-1 flex items-center justify-center border-b border-slate-800/50">
              <Image
                src="/images/logo.png"
                alt="Logo"
                width={70}
          ...
          <div className="flex items-center justify-between px-4 py-2.5">
            <div className="flex items-center gap-2">
              ...
              <button
                type="button"
                onClick={() => setTheme(!isDark)}
                className="p-1.5 rounded-md text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800"
      ...
      <main className="flex-1 min-w-0 overflow-x-hidden bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">{children}</main>
      </div>
    </div>
  );
}
