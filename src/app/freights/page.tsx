        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-5">
              <Field label="Cargo Description" required className="md:col-span-2">
                <input
                  name="cargo"
                  value={form.cargo}
                  onChange={handleChange}
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="rounded-xl border border-gray-200 p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Field label="Address / City, State" required className="md:col-span-2">
                    <input
                      name="pickupAddress"
              ...
              <div className="rounded-xl border border-gray-200 p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Field label="Address / City, State" className="md:col-span-2">
                    <input
            ...
            <div className="mt-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              <p className="text-sm text-gray-600">
                ...
                regarding your shipment details.
              </p>
              <button
                type="submit"
                disabled={loading}
