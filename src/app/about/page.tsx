      ...
      <div className="relative z-20 bg-[#1b1b1b] mt-[-50px] rounded-t-3xl shadow-lg">
        <div className="custom-container py-16 px-6 md:px-0 max-w-4xl mx-auto text-center">
          ...
          >
            ...
            nationwide transportation solutions. With years of experience in
            freight delivery, our mission is to offer secure, efficient, and
            on-time services for every client we serve.
          </motion.p>
          ...
          >
            From small packages to full truckloads, our team is dedicated to
            ensuring that every delivery is handled with precision and care. We
            value trust, safety, and commitment — the three pillars that define
            our company.
          </motion.p>
        </div>
